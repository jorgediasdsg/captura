...
sleep 5
r(){ grep -v "^#" $s > g; while read n k; do d=$(date +%d-%m-%Y-%X); $w $k; e "$n - $d - $k" >> r; sleep 10; gnome-screenshot -f $l/$n-$d.png; done < g; killall $a; }
...
v(){ rm -rf $l/*.zip $l/c $l/y  $l/r $l/g; p "SESSAO ENCERRADA, PODE VOLTAR A TOMAR CAFÉ"; }
r; t; u; j; v; killall gnome-terminal-server
