...
d=$(date +%d-%m-%Y-%X); s=sites.txt; m=emails.txt; l=$HOME/git/captura; w=google-chrome-stable; a=chrome
...
v(){ rm -rf $l/*.zip $l/c $l/y $l/r; p "SESSAO ENCERRADA, PODE VOLTAR A TOMAR CAFÉ"; $w; }
r; t; u; j; v; exit 
